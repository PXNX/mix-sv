...
type LayoutRouteId = RouteId | "/" | "/(admin)/pending" | "/(authorized)/channel/[id]/edit" | "/(authorized)/channel/new" | "/(authorized)/submissions" | "/(public)/about" | "/(public)/auth/login" | "/(public)/contact" | "/(public)/favorites" | "/(public)/privacy-policy" | "/(public)/terms-of-service" | "/channel/[id]" | null
