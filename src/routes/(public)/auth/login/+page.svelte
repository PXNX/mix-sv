...
<svelte:head>
	<title>Login - NewsMix Sources</title>
	<meta name="description" content="Login to access NewsMix Sources features" />
</svelte:head>
...
<header class="mb-6 text-center">
	...
	<h1 class="text-2xl font-bold text-white">NewsMix Sources</h1>
	...
	<div class="card-body gap-4 p-6">
		...
		<div class="flex justify-center">
			<script
				...
				data-size="large"
				data-auth-url="/auth/callback/telegram"
